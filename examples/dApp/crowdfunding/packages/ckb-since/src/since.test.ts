...
function assert_eq<T extends { eq(other: any): boolean }>(
    ...
    expect(a?.eq(b instanceof Object ? b : new (a!.constructor as any)(b)))
        .toBe(true);
}
...
describe("unit test", () => {
    test("success", () => {
        ...
        assert_eq(Since.fromEpoch(EpochNumberWithFraction.fromFullValue(1n), true), 0x2000_0100_0000_0001n);
        assert_eq(Since.fromEpoch(EpochNumberWithFraction.fromFullValue(1n), false), 0xa000_0100_0000_0001n);
        ...
        assert_eq(EpochNumberWithFraction.create(16777215n, 65534n, 65535n), 0xFF_FFFF_FEFF_FFFFn);
        ...
        assert(Since.fromBlockNumber(1234n, true)!.lt(Since.fromBlockNumber(2000n, true)!));
        assert(Since.fromBlockNumber(2001n, false)!.gt(Since.fromBlockNumber(2000n, false)!));
        assert(Since.fromTimestamp(3111n, true)!.gt(Since.fromTimestamp(2000n, true)!));
        assert(Since.fromTimestamp(1999n, false)!.lt(Since.fromTimestamp(2000n, false)!));

        assert(
            Since.fromEpoch(EpochNumberWithFraction.create(100n, 999n, 1000n)!, true)!.lt(
                Since.fromEpoch(EpochNumberWithFraction.create(101n, 1n, 1000n)!, true)!)
        );
        assert(
            Since.fromEpoch(EpochNumberWithFraction.create(100n, 600n, 1000n)!, true)!.lt(
                Since.fromEpoch(EpochNumberWithFraction.create(100n, 8n, 10n)!, true)!)
        );

        assert(Since.fromBlockNumber(1234n, true)!.cmp(Since.fromBlockNumber(2000n, false)!) === null)
        assert(
            Since.fromEpoch(EpochNumberWithFraction.create(100n, 999n, 1000n)!, false)!
                .cmp(
                    Since.fromEpoch(EpochNumberWithFraction.create(101n, 1n, 1000n)!, true)!) === null)
        assert(Since.fromTimestamp(1234n, true)!.cmp(Since.fromTimestamp(2000n, false)!) === null)
        assert(Since.fromBlockNumber(1234n, true)!.cmp(Since.fromTimestamp(2000n, false)!) === null)
        assert(Since.fromBlockNumber(1234n, true)!
            .cmp(
                Since.fromEpoch(EpochNumberWithFraction.create(101n, 1n, 1000n)!, true)!) === null)
        assert(Since.fromTimestamp(1234n, true)!
            .cmp(
                Since.fromEpoch(EpochNumberWithFraction.create(101n, 1n, 1000n)!, true)!) === null)
    });
});